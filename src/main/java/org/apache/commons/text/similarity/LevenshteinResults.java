...
/**
 * Container class to store Levenshtein distance between two character sequence. It also stores the count of inserts,
 * deletions and substitutions needed to change one character sequence to other.
 * 
 */
public class LevenshteinResults {
    ...
    /**
     * gets the number of insertion needed to change one character sequence to other.
     * 
    ...
    /**
     * get the number of character substitution needed to change one character sequence to other.
     * 
    ...
    public String toString() {
        return "LevenshteinResults [distance=" + distance + ", insertCount=" + insertCount + ", deleteCount="
                + deleteCount + ", substituteCount=" + substituteCount + "]";
    }
